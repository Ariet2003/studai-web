              ...
              <div className="md:col-span-2 grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <CustomSelect
                    ...
                    onChange={(value) => updateFormData('workLanguage', value)}
                    isDarkMode={isDarkMode}
                    options={[
                      { value: 'russian', label: t.workGenerator.form.workLanguageOptions.russian },
                      { value: 'kyrgyz', label: t.workGenerator.form.workLanguageOptions.kyrgyz },
                      { value: 'english', label: t.workGenerator.form.workLanguageOptions.english }
                    ]}
                  />
                </div>
                ...
                <div>
                  ...
                  <CustomSelect
                    ...
                    onChange={(value) => updateFormData('pageCount', value)}
                    isDarkMode={isDarkMode}
                    options={[
                      { value: 'pages5_10', label: t.workGenerator.form.pageCountOptions.pages5_10 },
                      { value: 'pages10_20', label: t.workGenerator.form.pageCountOptions.pages10_20 },
                      { value: 'pages20_30', label: t.workGenerator.form.pageCountOptions.pages20_30 },
                      { value: 'pages30_40', label: t.workGenerator.form.pageCountOptions.pages30_40 }
                    ]}
                  />
                </div>
              </div>
